...
def main(winning_numbers, tries, total_prize, total_cost):
    ...
    out_file = open('Lotto.lottery.html', 'w', encoding='utf-8')
...
# define constants
WINNING_NUMBERS = Lotto.lottery.draw_winning_numbers()
NUM_TRIES = 100
...
for i in range(NUM_TRIES):
    attempt = Lotto.lottery.generate_numbers()
    prize = Lotto.lottery.check(attempt, WINNING_NUMBERS)
